...
import "./CustomPatternInput.scss";
import InvalidMessage from "../InvalidMessage/InvalidMessage";

interface IUncontrolledCustomNumberFieldProps extends Omit<PatternFormatProps, "onBlur"> {
...
export const UncontrolledCustomNumberInput = ({ removeFormatFocus = true, format, ...props }: IUncontrolledCustomNumberFieldProps) => {
...
const CustomPatternInput = <TFields extends FieldValues>({
	name,
	control,
	label,
