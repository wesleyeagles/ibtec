				...
				<Offcanvas placement="end" show={show} onHide={handleClose}>
					<Offcanvas.Body>
								...
								<Collapse in={open}>
									<div id="collapse-text-institucional">
										<div className="links-expansibles">
											...
											>
												<Link to="/sobre">Trajectory</Link>
											</span>
											<span onClick={handleClose} className="link-expansible">
												<Link to="/conselho-de-administracao">Administrative Council</Link>
											</span>
											<span onClick={handleClose} className="link-expansible">
												<Link to="/responsabilidade-social">Social responsability</Link>
											</span>
											<span onClick={handleClose} className="link-expansible">
						...
						<div className="offcanvas-footer">
							<span className="offcanvas-title">Address</span>
							<p className="offcanvas-text text-white">
								Novo Hamburgo - RS <br />
								Rua Araxá, 750B. Ideal, <br />
								CEP: 93334-000
							</p>
							<span className="offcanvas-title">Email</span>
							<p className="offcanvas-text text-white">ibtec@ibtec.org.br</p>
							<span className="offcanvas-title">Phone</span>
